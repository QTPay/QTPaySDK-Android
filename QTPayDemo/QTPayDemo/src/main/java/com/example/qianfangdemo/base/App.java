...
import com.example.qianfangdemo.Utils.SharedPreferencesAccess;
...
public class App extends Application {
    ...
    public static String getLastOrderNo() {
        return sharedPreferencesAccess.getString("LAST_ORDER_NO", "");
    }

    public static void putLastOrderNo(String order_no) {
        sharedPreferencesAccess.putString("LAST_ORDER_NO", order_no);
    }

    public static void putLastOrderAmt(String amt) {
        sharedPreferencesAccess.putString("LAST_ORDER_AMT", amt);
    }

    public static String getLastOrderAmt() {
        return sharedPreferencesAccess.getString("LAST_ORDER_AMT", "0");
    }
